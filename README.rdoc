...
This time, however, we were prepared. As soon as he arrived, we selected a few days to work on a project together. 

During a short period of brainstorming, a few ideas were tossed up: 
	• Ecommerce site to sell cookies
	• Social networking site
	• Chore app
	• Knowledge Base/Wikipedia type site

Finally, a single project was selected: a chore app, which would contain user profiles, lists of chores, a reward system, etc. 
